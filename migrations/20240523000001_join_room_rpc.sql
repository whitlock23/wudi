...
begin
  ...
  if v_room.password is not null and v_room.password != '' and v_room.password != p_password then
  ...
  -- For simplicity now, just use current_players count, but robust logic would find gaps
